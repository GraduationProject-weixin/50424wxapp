...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1NvtMeFEiw?p=84)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对高校教师成果信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款微信小程序养老院系统这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短高校教师成果信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约高校教师成果信息管理需要的人力和资金。所以微信小程序养老院系统是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对高校教师成果信息管理，采用微信小程序养老院系统可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用微信小程序养老院系统，其意义如下：

第一点：微信小程序养老院系统的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对微信小程序养老院系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对微信小程序养老院系统进行介绍时，将按照如下内容进行。

第一部分：介绍微信小程序养老院系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发微信小程序养老院系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对微信小程序养老院系统的功能要求，以及对微信小程序养老院系统的性能要求等；
...
# 第2章 开发环境与技术
微信小程序养老院系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对微信小程序养老院系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
HTML作为一种超文本标记语言，是目前学习网站必须学习的第一门语言，要熟悉里面很多种标记，这种标记就是网页专属标记，只有这样浏览器才能解析相关信息。HTML里面包含了整整一套的标签，各种标签都有自己的功能，并且可以循环嵌套这些标签，比如一个表格里套着两个小小的表格。HTML一般文件名称的后缀都是html作为后缀，文档一般叫做微信小程序页面，里面的描述性标记语法被称为代码。
## 2.8 MyEclipse开发工具
...
### 3.1.2 经济可行性
本系统开发期间需要配置的软件环境，可以免费通过开发类官网下载安装，需要配置的硬件设备也不需要具备很高的性能，通常网吧电脑，或学校计算机机房的电脑都符合要求。因此，从经济方面考虑，微信小程序养老院系统开发可行。
### 3.1.3 操作可行性
微信小程序养老院系统根据用户使用习惯进行开发，设计的界面具有统一性，并具备优秀的导航功能。所以，只要会简单操作电脑的人员，可以无压力操作微信小程序养老院系统。
...
![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\论坛.jpg](/md/blog.006.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\论坛.jpg")
论坛实体属性图

（2）下图是服务项目预约实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\服务项目预约.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\服务项目预约.jpg")
服务项目预约实体属性图
...
![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\餐食目录.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\餐食目录.jpg")
餐食目录实体属性图

（5）下图是服务项目实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\服务项目.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\服务项目.jpg")
服务项目实体属性图

（6）下图是公告资讯实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\公告资讯.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\公告资讯.jpg")
公告资讯实体属性图

（7）下图是商品订单实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\商品订单.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\商品订单.jpg")
商品订单实体属性图

（8）下图是医生实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\医生.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\2\\_\_\_\_img\医生.jpg")
医生实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fuwuxiangmu\_name|String|服务项目名称|是|
|3|fuwuxiangmu\_types|Integer|服务项目类型|是|
|4|fuwuxiangmu\_photo|String|服务项目封面|是|
|5|fuwuxiangmu\_content|String|服务项目介绍|是|
|6|fuwuxiangmu\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|fuwuxiangmu\_id|Integer|服务项目|是|
|3|yonghu\_id|Integer|用户|是|
|4|fuwuxiangmu\_yuyue\_time|Date|预约时间|是|
|5|fuwuxiangmu\_yuyue\_yesno\_types|Integer|审核状态|是|
|6|fuwuxiangmu\_yuyue\_yesno\_text|String|审核回复|是|
|7|fuwuxiangmu\_yuyue\_shenhe\_time|Date|审核时间|是|
|8|insert\_time|Date|服务项目服务项目时间|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|meishi\_name|String|餐食名称|是|
|3|meishi\_types|Integer|餐食类型|是|
|4|fuwuxiangmu\_photo|String|餐食封面|是|
|5|meishi\_content|String|餐食介绍|是|
|6|meishi\_delete|Integer|逻辑删除|是|
|7|insert\_time|Date|录入时间|是|
|8|create\_time|Date|创建时间|是|
表4.6公告资讯表
...
|4|yisheng\_photo|String|医生头像|是|
|5|yisheng\_email|String|医生邮箱|是|
|6|yisheng\_types|Integer|科室|是|
|7|yisheng\_number|Integer|挂号人数限制|是|
|8|yisheng\_newMoney|BigDecimal|挂号价格|是|
|9|yisheng\_time|Date|在诊日期|是|
|10|yisheng\_zhicheng|String|职称|是|
|11|yisheng\_content|String|医生简介|是|
|12|yisheng\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|yisheng\_order\_uuid\_number|String|编号|是|
|3|yisheng\_id|Integer|医生|是|
|4|yonghu\_id|Integer|用户|是|
|5|yisheng\_order\_time|Date|挂号日期|是|
|6|shijianduan\_types|Integer|挂号时间段|是|
|7|yisheng\_order\_true\_price|BigDecimal|实付价格|是|
|8|yisheng\_order\_types|Integer|订单类型|是|
...
图5.2 医生信息管理页面
### 5.3服务项目管理
如图5.3显示的就是服务项目管理页面，此页面提供给管理员的功能有：根据服务项目进行条件查询，还可以对服务项目进行新增、修改、查询操作等等。
